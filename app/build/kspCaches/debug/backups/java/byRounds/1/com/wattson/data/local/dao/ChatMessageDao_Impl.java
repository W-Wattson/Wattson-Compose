  ...
  public ChatMessageDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfChatMessageEntity = new EntityInsertionAdapter<ChatMessageEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `chat_messages` (`id`,`conversationId`,`role`,`content`,`timestamp`) VALUES (?,?,?,?,?)";
      }
      ...
      public List<ChatMessageEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new ChatMessageEntity(_tmpId,_tmpConversationId,_tmpRole,_tmpContent,_tmpTimestamp);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public ChatMessageEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpTimestamp;
            _tmpTimestamp = _cursor.getLong(_cursorIndexOfTimestamp);
            _result = new ChatMessageEntity(_tmpId,_tmpConversationId,_tmpRole,_tmpContent,_tmpTimestamp);
          } else {
            _result = null;
          }
          return _result;
